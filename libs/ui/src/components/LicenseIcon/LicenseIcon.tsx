...
export const CC = ({ className }: SVGIconProps) => (
  <svg
    fill="currentColor"
    version="1.0"
...
export const CCBY = ({ className }: SVGIconProps) => (
  <svg
    fill="currentColor"
    version="1.0"
    xmlns="http://www.w3.org/2000/svg"
...
export const CCSA = ({ className }: SVGIconProps) => (
  <svg
    fill="currentColor"
    version="1.0"
    xmlns="http://www.w3.org/2000/svg"
    ...
    case 'CC-BY':
      return (
        <span className="flex gap-1">
          <CC className={className} /> <CCBY className={className} />
        </span>
      )
    case 'CC-BY-SA':
      return (
